	...
	return []NavSection{
		{
			...
			Items: []NavItem{
				...
				{Key: "catalog", Href: "/catalog", Icon: "package",
					NameAr: "كتالوج الأدوية", NameEn: "Drug Catalog",
					Perm: "pharmacy.purchase_request.view", Also: []string{"pharmacy.dashboard.view"}},
		...
		},
		{
			...
			Items: []NavItem{
				...
				{Key: "institutional_work", Href: "/customer/institutional-work", Icon: "layers",
					NameAr: "الأعمال المؤسسية", NameEn: "Institutional work",
					Perm: "pharmacy.institutional.view"},
