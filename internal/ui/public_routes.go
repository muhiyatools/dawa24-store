...
func (h *UIHandler) RegisterPublicRoutes(r chi.Router) {
	...
	r.Group(func(pub chi.Router) {
		...
		pub.Get("/auth/forgot/verify", h.ForgotVerifyPage)
		...
		if h.limiter != nil {
			...
			pub.With(h.limiter.LimitByIP(5, time.Minute)).Post("/auth/forgot", h.ForgotSubmit)
			pub.With(h.limiter.LimitByIP(15, time.Minute)).Post("/auth/forgot/verify-otp", h.ForgotVerifyOTPSubmit)
			pub.With(h.limiter.LimitByIP(10, time.Minute)).Post("/auth/reset", h.ResetPasswordSubmit)
			pub.With(h.limiter.LimitByIP(10, time.Minute)).Post("/auth/email/send-otp", h.SendEmailOTP)
			pub.With(h.limiter.LimitByIP(20, time.Minute)).Post("/auth/email/verify-otp", h.VerifyEmailOTP)
			pub.With(h.limiter.LimitByIP(10, time.Minute)).Post("/auth/telegram/send-otp", h.SendTelegramOTP)
			pub.With(h.limiter.LimitByIP(20, time.Minute)).Post("/auth/telegram/verify-otp", h.VerifyTelegramOTP)
			...
			pub.Post("/auth/forgot", h.ForgotSubmit)
			pub.Post("/auth/forgot/verify-otp", h.ForgotVerifyOTPSubmit)
			pub.Post("/auth/reset", h.ResetPasswordSubmit)
			pub.Post("/auth/email/send-otp", h.SendEmailOTP)
			pub.Post("/auth/email/verify-otp", h.VerifyEmailOTP)
			pub.Post("/auth/telegram/send-otp", h.SendTelegramOTP)
			pub.Post("/auth/telegram/verify-otp", h.VerifyTelegramOTP)
