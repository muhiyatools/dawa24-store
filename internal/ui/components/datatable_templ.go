		...
		default:
			...
			for _, col := range props.Columns {
				...
				if col.Sortable && props.SortURL != "" {
					...
					var templ_7745c5c3_Var2 templ.SafeURL = templ.SafeURL(props.SortURL + "?sort=" + col.Key)
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/components/datatable.templ`, Line: 52, Col: 28}
					}
