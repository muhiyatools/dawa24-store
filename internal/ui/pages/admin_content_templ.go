			...
			if len(blocks) == 0 {
				...
				for _, b := range blocks {
					...
					if previewURL != "" {
						...
						var templ_7745c5c3_Var17 templ.SafeURL = templ.SafeURL(previewURL)
					...
					var templ_7745c5c3_Var19 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/admin/content/%d/toggle", b.ID))
					...
					var templ_7745c5c3_Var20 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/admin/content/%d/delete", b.ID))
