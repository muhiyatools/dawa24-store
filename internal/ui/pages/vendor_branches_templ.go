			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if b.Status == "active" {
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<span class=\"badge badge-slate\" style=\"font-size:0.7rem; font-weight:800;\">غير نشط</span>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
