		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "\" style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-xl); padding:1.4rem; display:flex; flex-direction:column; gap:0.9rem; transition:border-color 150ms;\"><!-- Card Header --><div style=\"display:flex; justify-content:space-between; align-items:flex-start; gap:0.75rem; flex-wrap:wrap;\"><div><div class=\"row-center-sm\"><h3 class=\"text-lg fw-800 text-primary m-0\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "</div><div class=\"row-center-sm\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					if b.GoogleMapsURL != "" {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 37, "<!-- Card Actions --><div style=\"display:flex; justify-content:space-between; align-items:center; border-top:1px solid var(--border); padding-top:0.75rem; margin-top:0.25rem;\"><div class=\"text-xs text-muted tabular-nums\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 48, "</select></div><div><label class=\"field-label\">مدير الفرع المسؤول (من الموظفين)</label> <select name=\"manager_id\" class=\"form-input w-full\"><option value=\"\">-- تعيين مدير من موظفي المنشأة --</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
