...
func VendorBranchesPage(data VendorBranchesData, lang, dir string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "</div><div style=\"font-size:0.75rem; color:var(--text-muted); margin-top:0.2rem;\">فروع ومخازن نشطة</div></div><div style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-xl); padding:1.2rem 1.4rem; border-inline-start:4px solid var(--success);\"><div class=\"text-sm fw-700 text-muted\">سلاسل تبريد دوائية</div><div style=\"font-size:1.75rem; font-weight:800; color:var(--success); margin-top:0.25rem;\" class=\"tabular-nums\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</div><div style=\"font-size:0.75rem; color:var(--text-muted); margin-top:0.2rem;\">مخازن مجهزة (2° - 8° مئوية)</div></div><div style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-xl); padding:1.2rem 1.4rem; border-inline-start:4px solid var(--secondary);\"><div class=\"text-sm fw-700 text-muted\">المساحة التخزينية الكلية</div><div style=\"font-size:1.75rem; font-weight:800; color:var(--text); margin-top:0.25rem;\" class=\"tabular-nums\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					var templ_7745c5c3_Var16 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/branches/%d/edit", b.ID))
					...
					var templ_7745c5c3_Var17 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/branches/%d/delete", b.ID))
			...
			for _, c := range data.Cities {
				...
				templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", c.Latitude))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", c.Longitude))
				if templ_7745c5c3_Err != nil {
			...
			for _, emp := range data.Employees {
				if emp.Member != nil {
					...
					templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", emp.Member.UserID))
					if templ_7745c5c3_Err != nil {
			...
			for _, cat := range institutionalWorkCategories {
				...
				templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.JoinStringErrs(cat.Key)
				if templ_7745c5c3_Err != nil {
