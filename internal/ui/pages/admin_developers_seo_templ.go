...
func AdminDevelopersSEOTab(seo *AdminDevelopersSEOValues, lang, dir string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(seo.SearchQuery)
		if templ_7745c5c3_Err != nil {
		...
		for _, p := range seo.Pages {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(p.MetaDescAR)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("openEdit({id: %d, route_pattern: '%s', title_ar: '%s', title_en: '%s', meta_desc_ar: '%s', meta_desc_en: '%s', canonical_url: '%s', robots_directives: '%s', og_title: '%s', og_desc: '%s', og_image: '%s', twitter_card: '%s', keywords: %s, is_public: %t})",
