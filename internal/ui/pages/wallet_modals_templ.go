...
func WalletModals(data WalletViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 templ.SafeURL = templ.SafeURL(ternary(data.IsVendor, "/vendor/wallet/deposit", "/customer/wallet/deposit"))
		...
		if len(data.PlatformPaymentMethods) > 0 {
			for _, ppm := range data.PlatformPaymentMethods {
				if ppm.IsDepositEnabled && ppm.IsActive {
					...
					templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(ppm.ID)
					if templ_7745c5c3_Err != nil {
		...
		var templ_7745c5c3_Var5 templ.SafeURL = templ.SafeURL(ternary(data.IsVendor, "/vendor/wallet/withdraw", "/customer/wallet/withdraw"))
		...
		var templ_7745c5c3_Var6 = []any{"text-base font-black tabular-nums", walletAvailableBalanceClass(data.Wallet)}
		...
		if len(data.PaymentMethods) > 0 {
			...
			for _, pm := range data.PaymentMethods {
				...
				templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", pm.ID))
				if templ_7745c5c3_Err != nil {
