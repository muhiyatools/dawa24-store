...
func RequestsContent(lang, statusFilter string, data RequestsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, s := range data.Suppliers {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 50, Col: 47}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 50, Col: 84}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 1, Col: 0}
		}
		...
		if len(data.Requests) == 0 {
			...
			for _, q := range data.Requests {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 100, Col: 80}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 101, Col: 85}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 109, Col: 109}
				}
				...
				if q.ToOrgID == data.CurrentOrgID && q.Status == "pending" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 113, Col: 97}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/requests.templ`, Line: 117, Col: 97}
					}
