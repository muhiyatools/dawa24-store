	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			for _, s := range data.Suppliers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 34, Col: 47}
				}
				...
				templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(s.TradeName.Get(i18n.Lang(lang)))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 34, Col: 84}
				}
			...
			var templ_7745c5c3_Var5 = []any{TabClass(statusFilter, "")}
			...
			var templ_7745c5c3_Var7 = []any{TabClass(statusFilter, "pending")}
			...
			var templ_7745c5c3_Var9 = []any{TabClass(statusFilter, "accepted")}
			...
			var templ_7745c5c3_Var11 = []any{TabClass(statusFilter, "declined")}
			...
			if len(data.Requests) == 0 {
				...
				for _, q := range data.Requests {
					...
					templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(q.Title.Get(i18n.Lang(lang)))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 70, Col: 43}
					}
					...
					templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(reqTypeLabel(q.Type))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 71, Col: 35}
					}
					...
					templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(reqStatusLabel(q.Status))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 79, Col: 71}
					}
					...
					if q.ToOrgID == data.CurrentOrgID && q.Status == "pending" {
						...
						templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinURLErrs(fmt.Sprintf("/requests/%d/respond", q.ID))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 82, Col: 81}
						}
						...
						templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinURLErrs(fmt.Sprintf("/requests/%d/respond", q.ID))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/requests.templ`, Line: 86, Col: 81}
						}
		...
		templ_7745c5c3_Err = layouts.CustomerShell("الطلبات | Requests", lang, dir).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
