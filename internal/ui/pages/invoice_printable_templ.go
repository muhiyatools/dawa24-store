...
func InvoicePrintablePage(data billing.PrintableInvoiceData, lang, dir string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.InvoiceID > 0 {
			...
			var templ_7745c5c3_Var6 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/invoices/%d/excel", data.InvoiceID))
			...
			var templ_7745c5c3_Var7 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/invoices/%d/word", data.InvoiceID))
			...
			var templ_7745c5c3_Var8 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/orders/%d/invoice/excel", *data.OrderID))
			...
			var templ_7745c5c3_Var9 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/orders/%d/invoice/word", *data.OrderID))
		...
		templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(layouts.Nonce(ctx))
		if templ_7745c5c3_Err != nil {
