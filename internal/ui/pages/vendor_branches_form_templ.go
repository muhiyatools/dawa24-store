	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, emp := range data.Employees {
			if emp.Member != nil {
				...
				templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", emp.Member.UserID))
				if templ_7745c5c3_Err != nil {
		...
		for _, work := range data.InstitutionalWorks {
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", work.ID))
			if templ_7745c5c3_Err != nil {
