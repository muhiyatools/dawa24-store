...
func VendorBranchesForm(data VendorBranchesData, lang string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, c := range data.Cities {
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", c.Latitude))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.6f", c.Longitude))
			if templ_7745c5c3_Err != nil {
		...
		for _, emp := range data.Employees {
			if emp.Member != nil {
				...
				templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", emp.Member.UserID))
				if templ_7745c5c3_Err != nil {
		...
		for _, cat := range institutionalWorkCategories {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(cat.Key)
			if templ_7745c5c3_Err != nil {
