...
func VendorProductEditor(data VendorVariantEditorData, lang, dir string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"card\"><div><div>")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</div><div><h2>إضافة عرض توريد لصنف دوائي</h2><p>اختر الصنف من الكتالوج المعتمد وحدد سعر التوريد، الكمية، والخصم الممنوح للصيدليات</p></div></div><form action=\"/vendor/variants/new\" method=\"POST\" class=\"stack-lg\"><!-- 1. Master Product Selection --><div><label class=\"form-label\" for=\"var-master-prod\">الصنف الدوائي المعتمد من هيئة الدواء (Master Product) *</label> <select id=\"var-master-prod\" name=\"product_id\" class=\"form-select\" required><option value=\"\" disabled selected>اختر الدواء / الصنف الأساسي من القائمة</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
