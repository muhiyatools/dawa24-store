...
func CustomerJobsModals(lang, dir string, data CustomerJobsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 67, Col: 47}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 68, Col: 43}
					}
		...
		templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<form id=\"edit-job-form\" method=\"POST\" action=\"\" class=\"d-flex flex-col gap-3 m-0\"><!-- Job Title Arabic & English --><div class=\"d-grid grid-auto-fit-sm gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالعربية) <span class=\"text-danger\">*</span></label> <input type=\"text\" name=\"title_ar\" id=\"edit-job-title-ar\" required class=\"form-control font-semibold\"></div><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالإنجليزية)</label> <input type=\"text\" name=\"title_en\" id=\"edit-job-title-en\" class=\"form-control font-semibold\" dir=\"ltr\"></div></div><!-- Location & Status --><div class=\"d-grid grid-auto-fit-sm gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الفرع المخصص للشاغر <span class=\"text-danger\">*</span></label> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<input type=\"text\" name=\"location\" id=\"edit-job-location\" readonly class=\"form-control bg-surface-sunken\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 221, Col: 40}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 222, Col: 60}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 223, Col: 50}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 224, Col: 50}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 226, Col: 43}
					}
		...
		templ_7745c5c3_Var11 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<div id=\"applicants-modal-subtitle\" class=\"text-xs text-primary font-bold mb-3 pb-2 border-b\">الوظيفة: -</div><!-- Dynamic Content --> <div class=\"d-flex flex-col gap-3\" id=\"applicants-modal-content\"><!-- Populated by JS --></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 360, Col: 46}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_jobs_modals.templ`, Line: 361, Col: 42}
					}
