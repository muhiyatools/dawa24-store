...
func CustomerJobsModals(lang, dir string, data CustomerJobsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<form method=\"POST\" action=\"/customer/jobs\" class=\"d-flex flex-col gap-3 m-0\"><!-- Job Title Arabic & English --><div class=\"grid grid-cols-1 md:grid-cols-2 gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالعربية) <span class=\"text-danger\">*</span></label> <input type=\"text\" name=\"title_ar\" required class=\"form-control form-control-sm font-semibold\" placeholder=\"مثال: صيدلي أول / مساعد صيدلي\"></div><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالإنجليزية)</label> <input type=\"text\" name=\"title_en\" class=\"form-control form-control-sm font-semibold\" placeholder=\"e.g. Pharmacist / Branch Manager\" dir=\"ltr\"></div></div><!-- Location & Branch Selection --><div class=\"grid grid-cols-1 md:grid-cols-2 gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الفرع المخصص للشاغر <span class=\"text-danger\">*</span></label> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<div class=\"p-2.5 bg-surface-sunken border rounded-lg text-xs text-secondary\"><span>لم تسجل فروعاً بعد. سيتم ربط الوظيفة بـ <strong>(الفرع الرئيسي)</strong>. يمكنك إضافة فروعك من <a href=\"/customer/branches\" class=\"text-primary font-bold text-decoration-none\">إدارة الفروع ↗</a>.</span></div><input type=\"hidden\" name=\"location\" value=\"الفرع الرئيسي\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<select name=\"branch_id\" required class=\"form-select form-select-sm font-semibold\"><option value=\"\">-- اختر الفرع المتاح للوظيفة --</option> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</div><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">حالة الوظيفة <span class=\"text-danger\">*</span></label> <select name=\"status\" required class=\"form-select form-select-sm font-semibold\"><option value=\"published\">منشورة ومتاحة للتقديم (Published)</option> <option value=\"closed\">مغلقة ومكتفية (Closed)</option> <option value=\"draft\">مسودة غير معلنة (Draft)</option></select></div></div><!-- Salary Range --><div class=\"grid grid-cols-1 md:grid-cols-2 gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الحد الأدنى للراتب (اختياري)</label> <input type=\"number\" name=\"salary_min\" class=\"form-control form-control-sm tabular-nums font-mono\" placeholder=\"8000\"></div><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الحد الأقصى للراتب (اختياري)</label> <input type=\"number\" name=\"salary_max\" class=\"form-control form-control-sm tabular-nums font-mono\" placeholder=\"12000\"></div></div><!-- Description --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الوصف الوظيفي والمسؤوليات</label> <textarea name=\"description\" rows=\"3\" class=\"form-control form-control-sm\" placeholder=\"اكتب نبذة عن المسؤوليات اليومية، مواعيد الشفتات، وطبيعة العمل بالفرع...\"></textarea></div><!-- Requirements --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المتطلبات والمؤهلات المطلوبة</label> <textarea name=\"requirements\" rows=\"3\" class=\"form-control form-control-sm\" placeholder=\"مثال: بكالوريوس صيدلة، ترخيص مزاولة المهنة، خبرة سنة على الأقل...\"></textarea></div><!-- Form Actions --><div class=\"modal-footer pt-3 border-top d-flex items-center justify-between\"><button type=\"button\" class=\"btn btn-secondary font-bold\" onclick=\"closeAddJobModal()\">إلغاء</button> <button type=\"submit\" class=\"btn btn-primary font-bold px-6\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<form id=\"edit-job-form\" method=\"POST\" action=\"\" class=\"d-flex flex-col gap-3 m-0\"><!-- Job Title Arabic & English --><div class=\"grid grid-cols-1 md:grid-cols-2 gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالعربية) <span class=\"text-danger\">*</span></label> <input type=\"text\" name=\"title_ar\" id=\"edit-job-title-ar\" required class=\"form-control form-control-sm font-semibold\"></div><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي (بالإنجليزية)</label> <input type=\"text\" name=\"title_en\" id=\"edit-job-title-en\" class=\"form-control form-control-sm font-semibold\" dir=\"ltr\"></div></div><!-- Location & Status --><div class=\"grid grid-cols-1 md:grid-cols-2 gap-3\"><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الفرع المخصص للشاغر <span class=\"text-danger\">*</span></label> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<input type=\"text\" name=\"location\" id=\"edit-job-location\" readonly class=\"form-control form-control-sm bg-surface-sunken\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<select name=\"branch_id\" id=\"edit-job-branch-id\" required class=\"form-select form-select-sm font-semibold\"><option value=\"\">-- اختر الفرع المتاح للوظيفة --</option> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				for _, b := range data.Branches {
		...
		templ_7745c5c3_Var11 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<div id=\"applicants-modal-subtitle\" class=\"text-xs text-primary font-bold mb-3 pb-2 border-bottom\">الوظيفة: -</div><!-- Dynamic Content --> <div class=\"d-flex flex-col gap-3\" id=\"applicants-modal-content\"><!-- Populated by JS --></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "<div id=\"onboard-modal-subtitle\" class=\"text-xs text-muted font-bold mb-3 pb-2 border-bottom\">المتقدم: -</div><form class=\"d-flex flex-col gap-3 m-0\" id=\"onboard-employee-form\" onsubmit=\"submitOnboardEmployee(event)\"><input type=\"hidden\" id=\"onboard-job-id\" value=\"\"> <input type=\"hidden\" id=\"onboard-app-id\" value=\"\"><!-- Branch Selection --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الفرع المخصص للعمل <span class=\"text-danger\">*</span></label> <select id=\"onboard-branch-id\" required class=\"form-select form-select-sm font-semibold\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "</select></div><!-- Role / Permissions Selection --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الدور الوظيفي والصلاحيات <span class=\"text-danger\">*</span></label> <select id=\"onboard-role-key\" required class=\"form-select form-select-sm font-semibold\"><option value=\"org_pharmacist\">صيدلي مسؤول (طلبات، فواتير، استلام)</option> <option value=\"org_manager\">مدير فرع (صلاحيات كاملة للفرع)</option> <option value=\"org_employee\">موظف / كاشير (صلاحيات أساسية)</option> <option value=\"org_warehouse\">أمين مخزن (المخزون والاستلام)</option> <option value=\"org_accountant\">محاسب (المالية والفواتير)</option></select></div><!-- Job Title --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">المسمى الوظيفي المعتمد <span class=\"text-danger\">*</span></label> <input type=\"text\" id=\"onboard-job-title\" required class=\"form-control form-control-sm font-semibold\" placeholder=\"مثال: صيدلي أول / مدير شفت مسائي\"></div><!-- Salary --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">الراتب الأساسي (ج.م / شهرياً)</label> <input type=\"text\" id=\"onboard-base-salary\" class=\"form-control form-control-sm tabular-nums font-mono\" placeholder=\"مثال: 9500\"></div><!-- Notes --><div class=\"form-group mb-0\"><label class=\"form-label font-bold text-xs\">ملاحظات التعيين (اختياري)</label> <textarea id=\"onboard-notes\" rows=\"2\" class=\"form-control form-control-sm\" placeholder=\"ملاحظات حول موعد بدء العمل أو الشفت...\"></textarea></div><!-- Form Actions --><div class=\"modal-footer pt-3 border-top d-flex items-center justify-between\"><button type=\"button\" class=\"btn btn-secondary font-bold\" onclick=\"closeOnboardModal()\">إلغاء</button> <button type=\"submit\" id=\"onboard-submit-btn\" class=\"btn btn-primary font-bold px-6\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconCheck("icon-xs").Render(ctx, templ_7745c5c3_Buffer)
