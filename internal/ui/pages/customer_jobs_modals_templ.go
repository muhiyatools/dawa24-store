...
func CustomerJobsModals(lang, dir string, data CustomerJobsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<!-- ================= ADD JOB MODAL ================= --><div id=\"add-job-modal\" class=\"modal-backdrop hidden\"><div class=\"card\"><div class=\"section-head\"><div><h3>نشر وظيفة / شاغر صيدلاني جديد</h3><p>أدخل تفاصيل الشاغر لاستقبال طلبات التقديم والسير الذاتية من الكوادر المعتمدة.</p></div><button type=\"button\" class=\"btn btn-secondary btn-sm btn-icon\" onclick=\"closeAddJobModal()\">")
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "</button></div><!-- Dynamic Content --><div id=\"applicants-modal-content\"><!-- Populated by JS --></div></div></div><!-- ================= ONBOARD EMPLOYEE MODAL ================= --><div id=\"onboard-modal\" class=\"modal-backdrop hidden\"><div class=\"card\"><div><div><h3>قبول المتقدم وتعيينه كموظف</h3><p id=\"onboard-modal-subtitle\">المتقدم: -</p></div><button type=\"button\" class=\"btn btn-secondary btn-sm btn-icon\" onclick=\"closeOnboardModal()\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.IconX("icon-sm").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "</button></div><form id=\"onboard-employee-form\" onsubmit=\"submitOnboardEmployee(event)\"><input type=\"hidden\" id=\"onboard-job-id\" value=\"\"> <input type=\"hidden\" id=\"onboard-app-id\" value=\"\"><!-- Branch Selection --><div><label class=\"form-label\">الفرع المخصص للعمل <span class=\"text-danger\">*</span></label> <select id=\"onboard-branch-id\" required class=\"form-input field-cta\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if len(data.Branches) == 0 {
