...
func decisionMemoryContent(lang, dir string, data CustomerDecisionMemoryData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, d := range data.Decisions {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 221, Col: 34}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 227, Col: 22}
			}
			...
			if d.ChosenProductID != nil && *d.ChosenProductID > 0 {
				...
				if d.ChosenProductName != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 236, Col: 33}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 238, Col: 72}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 243, Col: 52}
				}
				...
				if d.ChosenProductSKU != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 247, Col: 41}
					}
			...
			if d.Confidence > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 262, Col: 52}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 272, Col: 41}
			}
			...
			if d.Reason != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 279, Col: 20}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 287, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 292, Col: 96}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 293, Col: 59}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 294, Col: 72}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 295, Col: 76}
			}
		...
		if data.Total > data.PerPage {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 311, Col: 95}
			}
			...
			if data.Page > 1 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 315, Col: 117}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 320, Col: 46}
			}
			...
			if data.Page*data.PerPage < data.Total {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `customer_decision_memory.templ`, Line: 323, Col: 117}
				}
