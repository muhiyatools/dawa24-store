...
func smartOrderResultRow(data SmartOrderResultsData, l *smartorder.Line) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var24, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(l.ID))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("dropdown-results-%d", l.ID))
		if templ_7745c5c3_Err != nil {
		...
		if l.Matched() {
			...
			var templ_7745c5c3_Var26 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/customer/smart-order/%s/lines/%d/match?product_id=0&match=%s&sort=%s&order=%s&page=%d&limit=%d&q=%s", data.Run.PublicID, l.ID, data.Match, data.SortBy, data.SortOrder, data.Page, data.PerPage, data.Search))
...
func smartOrderScript() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var34, templ_7745c5c3_Err = templ.JoinStringErrs(layouts.Nonce(ctx))
		if templ_7745c5c3_Err != nil {
