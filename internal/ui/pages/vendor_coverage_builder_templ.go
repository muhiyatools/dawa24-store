...
func VendorCoverageBuilder(data VendorCoverageData, lang string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, b := range data.Branches {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", b.ID))
			if templ_7745c5c3_Err != nil {
		...
		for _, g := range data.Governorates {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", g.ID))
			if templ_7745c5c3_Err != nil {
