		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 350, Col: 48}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 351, Col: 44}
					}
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 541, Col: 42}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 542, Col: 62}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 543, Col: 52}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 544, Col: 52}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 546, Col: 45}
					}
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 701, Col: 48}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `vendor_jobs.templ`, Line: 702, Col: 44}
					}
