...
func VendorJobs(lang, dir string, data VendorJobsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 59, "</div></div><!-- MODAL: Add New Job Modal --> <dialog id=\"add-job-modal\" class=\"modal\" aria-labelledby=\"add-job-title\"><div class=\"modal-box modal-lg\"><div class=\"modal-header\"><div class=\"d-flex items-center gap-3\"><div class=\"b2b-icon-box-sm\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconBriefcase("icon-sm").Render(ctx, templ_7745c5c3_Buffer)
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 60, "</div><div><h3 id=\"add-job-title\" class=\"modal-title\">نشر شاغر وظيفي جديد</h3><p class=\"text-xs text-muted mt-0.5 m-0\">تحديد مواصفات الوظيفة، المتطلبات والراتب المتوقع</p></div></div><form method=\"dialog\"><button type=\"submit\" class=\"modal-close\" aria-label=\"إغلاق\" onclick=\"closeAddJobModal()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if len(data.Branches) == 0 {
				...
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 351, Col: 48}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 352, Col: 44}
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 71, "</div><div><h3 id=\"edit-job-title\" class=\"modal-title\">تعديل بيانات وحالة الشاغر الوظيفي</h3><p class=\"text-xs text-muted mt-0.5 m-0\">تحديث المسمى الوظيفي، المتطلبات، الراتب وحالة نشر الوظيفة</p></div></div><form method=\"dialog\"><button type=\"submit\" class=\"modal-close\" aria-label=\"إغلاق\" onclick=\"closeEditJobModal()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconClose("icon-xs").Render(ctx, templ_7745c5c3_Buffer)
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 72, "</button></form></div><form id=\"edit-job-form\" method=\"POST\" action=\"\" class=\"stack-lg\"><!-- Titles --><div class=\"grid-2\"><div><label class=\"form-label\">المسمى الوظيفي (بالعربية) <span class=\"text-danger\">*</span></label> <input type=\"text\" name=\"title_ar\" id=\"edit-job-title-ar\" required class=\"form-input field-height\" placeholder=\"مثال: صيدلي أول / مندوب مبيعات\"></div><div><label class=\"form-label\">المسمى الوظيفي (بالإنجليزية)</label> <input type=\"text\" name=\"title_en\" id=\"edit-job-title-en\" class=\"form-input field-height\" placeholder=\"e.g. Senior Pharmacist / Sales Rep\"></div></div><!-- Location & Status --><div class=\"grid-2\"><div><label class=\"form-label\">الفرع المخصص للشاغر <span class=\"text-danger\">*</span></label> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 73, "<input type=\"text\" name=\"location\" id=\"edit-job-location\" readonly class=\"form-input\" style=\"height:44px; border-radius:var(--radius-lg); background:var(--surface-sunken);\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 74, "<select name=\"branch_id\" id=\"edit-job-branch-id\" required class=\"form-input field-cta\"><option value=\"\">-- اختر الفرع المتاح للوظيفة --</option> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 520, Col: 42}
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var32)
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 76, "\" data-branch-name=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var33 string
					templ_7745c5c3_Var33, templ_7745c5c3_Err = templ.ResolveAttributeValue(b.Name.Get(i18n.ParseLang(lang)))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 521, Col: 62}
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var33)
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 77, "\" data-branch-name-ar=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var34 string
					templ_7745c5c3_Var34, templ_7745c5c3_Err = templ.ResolveAttributeValue(b.Name.Get(i18n.AR))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 522, Col: 52}
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var34)
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 78, "\" data-branch-name-en=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var35 string
					templ_7745c5c3_Var35, templ_7745c5c3_Err = templ.ResolveAttributeValue(b.Name.Get(i18n.EN))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 523, Col: 52}
					}
					...
					templ_7745c5c3_Var36, templ_7745c5c3_Err = templ.JoinStringErrs(b.Name.Get(i18n.ParseLang(lang)))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 525, Col: 45}
					}
					...
					if b.IsMain {
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 81, "(الفرع الرئيسي)")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 85, "<span>حفظ التعديلات والتحديث</span></button></div></form></div></dialog><!-- ================= APPLICANTS MODAL ================= --> <dialog id=\"job-applicants-modal\" class=\"modal\" aria-labelledby=\"applicants-modal-title\"><div class=\"modal-box modal-lg\"><div class=\"modal-header\"><div><h3 id=\"applicants-modal-title\" class=\"modal-title\">طلبات التقديم والسير الذاتية</h3><p id=\"applicants-modal-subtitle\" class=\"text-xs text-brand font-bold mt-1 m-0\">الوظيفة: -</p></div><form method=\"dialog\"><button type=\"submit\" class=\"modal-close\" aria-label=\"إغلاق\" onclick=\"closeApplicantsModal()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconClose("icon-xs").Render(ctx, templ_7745c5c3_Buffer)
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 86, "</button></form></div><!-- Dynamic Content --><div id=\"applicants-modal-content\" class=\"modal-body\"><!-- Populated by JS --></div></div></dialog><!-- ================= ONBOARD EMPLOYEE MODAL ================= --> <dialog id=\"onboard-modal\" class=\"modal\" aria-labelledby=\"onboard-modal-title\"><div class=\"modal-box modal-md\"><div class=\"modal-header\"><div><h3 id=\"onboard-modal-title\" class=\"modal-title\">قبول المتقدم وتعيينه كموظف</h3><p id=\"onboard-modal-subtitle\" class=\"text-xs text-secondary mt-1 m-0\">المتقدم: -</p></div><form method=\"dialog\"><button type=\"submit\" class=\"modal-close\" aria-label=\"إغلاق\" onclick=\"closeOnboardModal()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconClose("icon-xs").Render(ctx, templ_7745c5c3_Buffer)
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 87, "</button></form></div><form id=\"onboard-employee-form\" onsubmit=\"submitOnboardEmployee(event)\" class=\"d-flex flex-col gap-4 m-0\"><input type=\"hidden\" id=\"onboard-job-id\" value=\"\"> <input type=\"hidden\" id=\"onboard-app-id\" value=\"\"><div class=\"modal-body d-flex flex-col gap-3\"><!-- Branch Selection --><div><label class=\"form-label font-bold text-xs\">الفرع / المستودع المخصص للعمل <span class=\"text-danger\">*</span></label> <select id=\"onboard-branch-id\" required class=\"form-select w-full\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Branches) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 88, "<option value=\"\">المقر الرئيسي / المستودع الرئيسي</option>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				for _, b := range data.Branches {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 685, Col: 49}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_jobs.templ`, Line: 686, Col: 45}
					}
					...
					if b.IsMain {
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 92, "(الرئيسي)")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 94, "</select></div><!-- Role / Permissions Selection --><div><label class=\"form-label font-bold text-xs\">الدور الوظيفي والصلاحيات <span class=\"text-danger\">*</span></label> <select id=\"onboard-role-key\" required class=\"form-select w-full\"><option value=\"org_sales_rep\">مندوب مبيعات / تسويق دوائي</option> <option value=\"org_warehouse\">أمين مخزن / مسؤول مستودع</option> <option value=\"org_manager\">مدير فرع / مسؤول تشغيل</option> <option value=\"org_accountant\">محاسب مالي</option> <option value=\"org_employee\">موظف تشغيل (صلاحيات أساسية)</option> <option value=\"org_pharmacist\">صيدلي / مستشار علمي</option></select></div><!-- Job Title --><div><label class=\"form-label font-bold text-xs\">المسمى الوظيفي المعتمد <span class=\"text-danger\">*</span></label> <input type=\"text\" id=\"onboard-job-title\" required class=\"form-input w-full\" placeholder=\"مثال: مندوب مبيعات طبي / مدير مستودع\"></div><!-- Salary --><div><label class=\"form-label font-bold text-xs\">الراتب الأساسي (ج.م / شهرياً)</label> <input type=\"text\" id=\"onboard-base-salary\" class=\"form-input tabular-nums w-full\" placeholder=\"مثال: 9500\"></div><!-- Notes --><div><label class=\"form-label font-bold text-xs\">ملاحظات التعيين (اختياري)</label> <textarea id=\"onboard-notes\" rows=\"2\" class=\"form-input text-xs w-full\" placeholder=\"ملاحظات حول موعد بدء العمل أو المستودع...\" style=\"resize:vertical;\"></textarea></div></div><!-- Form Actions --><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-secondary font-bold\" onclick=\"closeOnboardModal()\">إلغاء</button> <button type=\"submit\" id=\"onboard-submit-btn\" class=\"btn btn-primary font-bold px-6\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.IconCheck("icon-xs").Render(ctx, templ_7745c5c3_Buffer)
