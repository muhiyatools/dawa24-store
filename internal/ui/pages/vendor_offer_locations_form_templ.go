...
func VendorOfferLocationsForm(data VendorOfferLocationsData, lang string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/offers/%d/locations", data.Offer.ID))
		...
		for _, d := range daysOfWeek {
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("{ 'is-active': selectedDays.includes(%d) }", d.ID))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_offer_locations_form.templ`, Line: 58, Col: 79}
			}
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("selectedDays.includes(%d)", d.ID))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("toggleDay(%d)", d.ID))
			if templ_7745c5c3_Err != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_offer_locations_form.templ`, Line: 69, Col: 21}
			}
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("selectedDays.includes(%d)", d.ID))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/vendor_offer_locations_form.templ`, Line: 70, Col: 68}
			}
		...
		for _, g := range data.Governorates {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", g.ID))
			if templ_7745c5c3_Err != nil {
		...
		for _, c := range data.Cities {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", c.ID))
			if templ_7745c5c3_Err != nil {
