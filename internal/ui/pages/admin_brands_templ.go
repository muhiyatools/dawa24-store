			...
			if len(brands) == 0 {
				...
				for _, item := range brands {
					...
					if item.Brand.Image != "" {
						...
						templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(item.Brand.Image)
						if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("openProductsModal(%d, '%s', '%s', %d)", item.Brand.ID, templateEscape(item.Brand.Name.Get("ar")), templateEscape(item.Brand.Name.Get("en")), item.ProductCount))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("openEdit(%d, '%s', '%s', '%s', '%s', '%s', '%s')", item.Brand.ID, templateEscape(item.Brand.Name.Get("ar")), templateEscape(item.Brand.Name.Get("en")), templateEscape(item.Brand.Description.Get("ar")), templateEscape(item.Brand.Description.Get("en")), templateEscape(item.Brand.Image), item.Brand.Status))
					if templ_7745c5c3_Err != nil {
