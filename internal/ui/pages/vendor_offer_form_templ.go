...
func VendorOfferFormPage(data VendorOfferFormData, lang, dir string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</h1></div></div><a href=\"/vendor/offers\" class=\"btn btn-secondary btn-sm\" style=\"font-weight:700;\"><span>← العودة لجميع العروض</span></a></div><form action=\"/vendor/offers/new\" method=\"POST\" style=\"display:flex; flex-direction:column; gap:1.75rem;\"><!-- Grid 1: Basic Info & Pricing Details --><div style=\"display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;\" class=\"offer-form-grid\"><!-- Card 1: Basic Details --><div style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-2xl); padding:1.75rem; display:flex; flex-direction:column; gap:1.2rem;\"><h3 style=\"font-size:1.15rem; font-weight:800; color:var(--text); margin:0; border-bottom:1px solid var(--border); padding-bottom:0.75rem;\">البيانات الأساسية للعرض</h3><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">عنوان العرض (بالعربية) <span style=\"color:var(--danger);\">*</span></label> <input type=\"text\" name=\"title_ar\" required placeholder=\"مثال: خصم 20% على أدوية ومستلزمات الموسم\" class=\"form-input\" style=\"width:100%;\"></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">عنوان العرض (بالإنجليزية) <span style=\"color:var(--danger);\">*</span></label> <input type=\"text\" name=\"title_en\" placeholder=\"e.g. 20% Off Seasonal Medicines\" class=\"form-input\" style=\"width:100%;\"></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">وصف تفاصيل العرض</label> <textarea name=\"description_ar\" rows=\"3\" placeholder=\"اكتب تفاصيل وشروط الاستفادة من العرض...\" class=\"form-input\" style=\"width:100%; resize:vertical;\"></textarea></div><div style=\"display:grid; grid-template-columns:1fr 1fr; gap:0.9rem;\"><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">الفرع المستهدف</label> <select name=\"branch_id\" class=\"form-input\" style=\"width:100%;\"><option value=\"\">كافة الفروع</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</select></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">حالة العرض <span style=\"color:var(--danger);\">*</span></label> <select name=\"status\" class=\"form-input\" style=\"width:100%;\"><option value=\"active\">نشط (Active)</option> <option value=\"draft\">مسودة (Draft)</option> <option value=\"inactive\">غير نشط (Inactive)</option></select></div></div></div><!-- Card 2: Pricing, Dates & Image --><div style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-2xl); padding:1.75rem; display:flex; flex-direction:column; gap:1.2rem;\"><h3 style=\"font-size:1.15rem; font-weight:800; color:var(--text); margin:0; border-bottom:1px solid var(--border); padding-bottom:0.75rem;\">التسعير، التواريخ والصورة</h3><div style=\"display:grid; grid-template-columns:1fr 1fr; gap:0.9rem;\"><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">نسبة الخصم العامة %</label> <input type=\"number\" step=\"0.01\" name=\"discount_percentage\" placeholder=\"15.00\" class=\"form-input tabular-nums\" style=\"width:100%;\"></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">السعر الإجمالي الكلي (ج.م)</label> <input type=\"number\" step=\"0.01\" name=\"total_price\" placeholder=\"250.00\" class=\"form-input tabular-nums\" style=\"width:100%;\"></div></div><div style=\"display:grid; grid-template-columns:1fr 1fr; gap:0.9rem;\"><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">تاريخ بدء العرض</label> <input type=\"date\" name=\"start_date\" class=\"form-input\" style=\"width:100%; color-scheme:dark;\"></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">تاريخ انتهاء العرض</label> <input type=\"date\" name=\"end_date\" class=\"form-input\" style=\"width:100%; color-scheme:dark;\"></div></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">الحد الأدنى للطلب (ج.م)</label> <input type=\"number\" step=\"0.01\" name=\"min_order_amount\" placeholder=\"500.00\" class=\"form-input tabular-nums\" style=\"width:100%;\"></div><div><label style=\"display:block; font-size:0.8rem; font-weight:700; color:var(--text-secondary); margin-bottom:0.35rem;\">صورة البانر الترويجي للعرض</label> <input type=\"text\" name=\"image\" placeholder=\"رابط الصورة أو مسار البانر...\" class=\"form-input\" style=\"width:100%;\"></div></div></div><!-- Section 2: Products Selection & Custom Offer Pricing --><div style=\"background:var(--surface-raised); border:1px solid var(--border); border-radius:var(--radius-2xl); padding:1.75rem; display:flex; flex-direction:column; gap:1.25rem;\"><div style=\"display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:1rem; border-bottom:1px solid var(--border); padding-bottom:1rem;\"><div><h3 style=\"font-size:1.2rem; font-weight:800; color:var(--text); margin:0;\">تخصيص منتجات العرض (Offer Products)</h3><p style=\"font-size:0.8rem; color:var(--text-muted); margin:0.2rem 0 0 0;\">حدد أصناف الأدوية المشمولة في العرض مع تحديد الكميات والأسعار الخاصة بكل صنف</p></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
