...
func adminSettingsPaymentModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "</div><div><h3 class=\"text-base font-black text-primary m-0\" x-text=\"isEditingMethod ? 'تعديل وسيلة الدفع' : 'إضافة وسيلة دفع جديدة'\"></h3><div class=\"text-xs text-secondary mt-0.5\">ضبط الحسابات والقنوات المعتمدة لسداد الفواتير والشحن</div></div></div><button type=\"button\" onclick=\"document.getElementById('payment-method-modal').close()\" class=\"btn btn-secondary btn-xs btn-icon\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "<span x-text=\"isEditingMethod ? 'حفظ التعديلات' : 'إضافة وسيلة الدفع'\"></span></button></div></form></div></dialog>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
