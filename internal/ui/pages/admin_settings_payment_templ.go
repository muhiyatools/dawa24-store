...
func adminSettingsPaymentTab(paymentMethods []*billing.PlatformPaymentMethod) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, pm := range paymentMethods {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("openEditMethodModal({ id: %q, name_ar: %q, name_en: %q, provider_type: %q, bank_name: %q, account_name: %q, account_number: %q, iban: %q, swift_code: %q, branch_name: %q, instapay_handle: %q, phone_number: %q, description_ar: %q, is_active: %t, is_deposit_enabled: %t, is_checkout_enabled: %t, display_order: %d })",
				pm.ID,
				pm.Name.Get("ar"),
				pm.Name.Get("en"),
				pm.ProviderType,
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(pm.ID)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%t", !pm.IsCheckoutEnabled))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(pm.ID)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%t", !pm.IsActive))
			if templ_7745c5c3_Err != nil {
