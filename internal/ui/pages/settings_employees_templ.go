		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			for _, r := range roles {
				if r.Key != "org_owner" && r.Key != "org_manager" && r.Key != "org_pharmacist" && r.Key != "org_warehouse" && r.Key != "org_accountant" {
					...
					templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(r.Key)
					if templ_7745c5c3_Err != nil {
			...
			if len(branches) == 0 {
				...
				for _, b := range branches {
					...
					for _, emp := range employees {
						...
						templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", emp.Member.UserID))
						if templ_7745c5c3_Err != nil {
