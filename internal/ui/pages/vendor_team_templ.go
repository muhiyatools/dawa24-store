	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			for _, role := range data.CompanyRoles {
				...
				templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", role.ID))
				if templ_7745c5c3_Err != nil {
			...
			if len(data.Members) == 0 {
				...
				for _, m := range data.Members {
					...
					templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("matchesFilter({ name: %q, email: %q, phone: %q, jobTitle: %q, code: %q, roleKey: %q, roleId: %d, isActive: %t })", m.Name, m.Email, m.Phone, m.JobTitle, m.EmployeeCode, m.RoleKey, m.RoleID, m.IsActive))
					if templ_7745c5c3_Err != nil {
					...
					if m.AvatarURL != "" {
						...
						templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(m.AvatarURL)
						if templ_7745c5c3_Err != nil {
					...
					if data.CanAssignRole && m.RoleKey != "org_owner" {
						...
						var templ_7745c5c3_Var20 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/team/%d/role", m.ID))
						...
						for _, role := range data.CompanyRoles {
							...
							templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", role.ID))
							if templ_7745c5c3_Err != nil {
					...
					if m.Email != "" {
						...
						var templ_7745c5c3_Var26 templ.SafeURL = templ.SafeURL("mailto:" + m.Email)
					...
					if m.RoleKey != "org_owner" {
						...
						templ_7745c5c3_Var29, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("openEdit({ id: %d, name: %q, phone: %q, jobTitle: %q, code: %q, roleKey: %q, roleId: %d, branchId: %d, isActive: %t })", m.ID, m.Name, m.Phone, m.JobTitle, m.EmployeeCode, m.RoleKey, m.RoleID, m.BranchID, m.IsActive))
						if templ_7745c5c3_Err != nil {
						...
						if m.UserID != data.CurrentUserID {
							...
							var templ_7745c5c3_Var30 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/team/%d/toggle", m.ID))
							...
							templ_7745c5c3_Var31, templ_7745c5c3_Err = templ.JoinStringErrs(ifElseStr(m.IsActive, "تعطيل حساب الموظف", "تفعيل حساب الموظف"))
							if templ_7745c5c3_Err != nil {
							...
							var templ_7745c5c3_Var32 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/vendor/team/%d/delete", m.ID))
