		...
		if len(policies) == 0 {
			...
			for _, p := range policies {
				...
				if !p.IsPublished {
					...
					var templ_7745c5c3_Var12 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/admin/policies/%d/publish", p.ID))
...
func policyKeyAr(k string) string {
	...
	case "shipping_return", "refund":
		return "الشحن والاسترجاع والإلغاء"
	case "cookies":
