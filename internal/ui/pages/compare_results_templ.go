...
func CompareResultsPage(lang, dir string, result *compare.ComparisonResultSet, activeFilter string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</div><span class=\"text-xs text-secondary mt-1 d-block\">كشوف أسعار نشطة ومطابقة</span></div></div><!-- Filter Bar & Search --><div class=\"glass-panel p-6 d-flex flex-col gap-4\"><div class=\"flex-between flex-wrap gap-3\"><!-- Quick Filter Tabs --><div class=\"d-flex items-center gap-2 flex-wrap\"><button type=\"button\" class=\"btn btn-primary btn-sm tab-btn active font-bold\" data-filter=\"all\" onclick=\"applyTableFilter('all', this)\"><span>الكل (")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
