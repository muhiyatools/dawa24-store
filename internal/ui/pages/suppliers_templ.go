...
func SuppliersDirectoryContent(lang, dir string, data SupplierDirectoryData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 41, Col: 62}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 59, Col: 24}
		}
		...
		if len(data.Suppliers) == 0 {
			...
			for _, s := range data.Suppliers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 119, Col: 75}
				}
				...
				if s.Org.TradeName.Get(i18n.Lang(lang)) != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 121, Col: 52}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 123, Col: 31}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 128, Col: 97}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 137, Col: 47}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 155, Col: 73}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 166, Col: 65}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 172, Col: 32}
				}
				...
				if s.MinOrderPrice.Minor() > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 179, Col: 89}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 190, Col: 69}
				}
				...
				if s.Phone != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 198, Col: 58}
					}
