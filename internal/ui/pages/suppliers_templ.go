...
func SuppliersDirectoryContent(lang, dir string, data SupplierDirectoryData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 40, Col: 66}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 58, Col: 24}
		}
		...
		if len(data.Suppliers) == 0 {
			...
			for _, s := range data.Suppliers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 118, Col: 75}
				}
				...
				if s.Org.TradeName.Get(i18n.Lang(lang)) != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 120, Col: 52}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 122, Col: 31}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 127, Col: 97}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 136, Col: 47}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 154, Col: 73}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 165, Col: 65}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 171, Col: 32}
				}
				...
				if s.MinOrderPrice.Minor() > 0 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 178, Col: 89}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 189, Col: 69}
				}
				...
				if s.Phone != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `suppliers.templ`, Line: 197, Col: 58}
					}
