...
func ComparePlansPage(lang, dir string, plans []*billing.Plan) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(plans) == 0 {
				...
				for _, p := range plans {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/pages/compare_plans.templ`, Line: 35, Col: 85}
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "\" style=\"margin:0;\"><button type=\"submit\" class=\"btn btn-primary\" style=\"width:100%; justify-content:center;\">اشترك الآن</button></form></div></div>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
		...
		templ_7745c5c3_Err = layouts.CustomerShell("خطط مقارنة الخصومات | Plans", lang, dir).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func CompareToolPage(lang, dir string, entitled bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<div style=\"max-width:640px;\"><div class=\"card\" style=\"margin-bottom:0;\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if entitled {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<h2 style=\"font-size:1.25rem; font-weight:900; color:var(--primary-700); margin:0 0 0.75rem;\">أداة مقارنة الخصومات</h2><p style=\"color:var(--neutral-600); line-height:1.8;\">أنت مشترك في خطة المقارنة. ابحث عن منتج لمقارنة أسعاره عبر الموردين.</p><a href=\"/catalog\" class=\"btn btn-primary\" style=\"justify-content:center;\">ابحث عن منتج</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<h2 style=\"font-size:1.25rem; font-weight:900; color:var(--neutral-900); margin:0 0 0.75rem;\">هذه الميزة تتطلب اشتراكاً</h2><p style=\"color:var(--neutral-600); line-height:1.8;\">أداة مقارنة الخصومات متاحة للمشتركين في إحدى خطط المقارنة.</p><a href=\"/compare\" class=\"btn btn-primary\" style=\"justify-content:center;\">عرض الخطط</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		...
		templ_7745c5c3_Err = layouts.CustomerShell("أداة مقارنة الخصومات | Compare", lang, dir).Render(templ.WithChildren(ctx, templ_7745c5c3_Var7), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
