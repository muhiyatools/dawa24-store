...
func loadFrontendUIKeysA(e *engine) {
	...
	addKey(e, "customer.saving.import.processing_failed", "customer", "تعذر إكمال معالجة الملف بسبب خطأ داخلي. يرجى المحاولة مرة أخرى أو رفع الملف من جديد.", "Processing could not be completed because of an internal error. Please try again or upload the file afresh.", "Import run failed")
	addKey(e, "customer.saving.import.catalog_unavailable", "customer", "تعذر تحميل الكتالوج المركزي للمطابقة، لذلك تم إيقاف المعالجة بدلاً من إرجاع كل الأصناف كغير مرتبطة. يرجى المحاولة بعد قليل.", "The central catalogue could not be loaded for matching, so processing stopped instead of returning every item as unlinked. Please try again shortly.", "Catalogue unavailable during import")
