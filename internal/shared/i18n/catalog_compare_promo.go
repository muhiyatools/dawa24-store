...
func loadCompareAndPromoKeys(e *engine) {
	addKey(e, "customer.offer.unpriced", "promo", "هذا العرض غير مسعّر حالياً ولا يمكن شراؤه. يرجى التواصل مع المورد.", "This offer has no price set and cannot be purchased. Please contact the supplier.", "Offer missing a price")
	...
	addKey(e, "vendor.offer.location_updated_success", "vendor", "تم تحديث نطاق التغطية الجغرافي للعرض بنجاح.", "Geographic coverage location updated successfully.", "Success notice")
	addKey(e, "vendor.offer.location_deleted_success", "vendor", "تم حذف نطاق التغطية الجغرافي من العرض بنجاح.", "Geographic coverage location removed from offer successfully.", "Success notice")
	addKey(e, "vendor.offer.location_not_found", "vendor", "لم يتم العثور على نطاق التغطية المحدد.", "Specified coverage location not found.", "Not found error")
	addKey(e, "vendor.offer.city_required", "vendor", "يرجى تحديد المدينة أو المركز المستهدف للتغطية.", "Please select a target city for coverage.", "Validation error")
	addKey(e, "vendor.offer.city_mismatch", "vendor", "المدينة المحددة لا تنتمي إلى المحافظة المختارة.", "Selected city does not belong to the chosen governorate.", "Validation error")
	...
	addKey(e, "compare.upload.replace_reason", "compare", "تمت الأرشفة تلقائياً بعد استبدالها بكشوف مقارنة جديدة", "Archived automatically after being replaced by a newer comparison batch", "Archive reason")
	addKey(e, "compare.upload.replace_pending", "compare", " وسيتم أرشفة %d من الكشوف السابقة تلقائياً فور اكتمال المعالجة بنجاح.", " %d earlier list(s) will be archived automatically once processing succeeds.", "Auto-replacement notice")
	...
	addKey(e, "import.state.ready", "compare", "جاهز للمراجعة", "Ready for review", "Import state: ready")
	addKey(e, "import.state.committing", "compare", "جارٍ الحفظ…", "Saving…", "Import state: committing")
	addKey(e, "import.state.committed", "compare", "اكتمل الحفظ", "Saved", "Import state: committed")
	addKey(e, "import.state.failed", "compare", "تعذّر إكمال المعالجة", "Processing failed", "Import state: failed")
	addKey(e, "import.state.cancelled", "compare", "تم الإلغاء", "Cancelled", "Import state: cancelled")
