...
func loadCompareAndPromoKeys(e *engine) {
	...
	addKey(e, "compare.supplier_name", "compare", "اسم المورد", "Supplier Name", "Supplier name column")
	addKey(e, "compare.public_price", "compare", "السعر الرسمي", "Public Price", "Public price column")
	addKey(e, "compare.discount_rate", "compare", "نسبة الخصم", "Discount %", "Discount column")
	addKey(e, "compare.net_unit_price", "compare", "السعر الصافي للوحدة", "Net Unit Price", "Net price column")
