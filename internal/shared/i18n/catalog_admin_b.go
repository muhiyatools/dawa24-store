...
func loadAdminCatalogB(e *engine) {
	...
	addKey(e, "admin.finance.statement_select_org_required", "billing", "يرجى اختيار منشأة محددة لطباعة كشف حسابها.", "Please select an organization to print its statement.", "Validation error")
	addKey(e, "admin.finance.organization_not_found", "billing", "المنشأة المحددة غير موجودة.", "The selected organization was not found.", "Not found error")
	addKey(e, "admin.finance.refund_success", "billing", "تم تسجيل حركة الاسترداد وقيد المبلغ في المحفظة بنجاح.", "Refund recorded and wallet credited successfully.", "Success notice")
	addKey(e, "admin.finance.invalid_transaction_id", "billing", "معرف الحركة غير صالح.", "Invalid transaction ID.", "Validation error")
	addKey(e, "admin.finance.refund_reason_required", "billing", "يرجى تحديد سبب الاسترداد.", "Please specify a refund reason.", "Validation error")
