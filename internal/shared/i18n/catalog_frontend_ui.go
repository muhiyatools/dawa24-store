...
func loadFrontendUIKeys(e *engine) {
	...
	addKey(e, "settings.verified_badge", "settings", "حساب المؤسسة موثق ومعتمد رسمياً للتوريد والشراء المباشر عبر منظومة دواء 24.", "Organization account is verified and officially approved for direct procurement on Dawa24.", "Verified badge text")
	addKey(e, "settings.pref_title", "settings", "تفضيلات الإشعارات والتنبيهات", "Notification & Alert Preferences", "Preferences title")
	addKey(e, "settings.pref_whatsapp", "settings", "إشعارات الواتساب (WhatsApp Alerts)", "WhatsApp Alerts", "WhatsApp alert title")
	addKey(e, "settings.pref_whatsapp_desc", "settings", "استلام تحديثات تسليم الشحنات وتغير حالة أوامر الشراء فورياً", "Receive real-time delivery updates and purchase order status changes", "WhatsApp alert description")
	addKey(e, "settings.pref_invoices", "settings", "رسائل البريد الإلكتروني للفواتير الضريبية", "Tax Invoice Email Notifications", "Tax invoice alert title")
	addKey(e, "settings.pref_invoices_desc", "settings", "إرسال نسخة PDF معتمدة من الفاتورة الضريبية فور اكتمال الطلب", "Receive approved PDF tax invoices upon order completion", "Tax invoice alert description")
	...
	addKey(e, "pharmacy.dashboard.smart_matching_title", "pharmacy", "الطلب الذكي ومطابقة النواقص", "Smart Order & Shortage Matching", "Smart matching title")
	addKey(e, "pharmacy.dashboard.ai_badge", "pharmacy", "ذكاء اصطناعي", "AI Powered", "AI badge")
	addKey(e, "pharmacy.dashboard.smart_matching_desc", "pharmacy", "استيراد ومطابقة ملفات النواقص تلقائياً بأفضل عروض الموردين", "Import and match shortage lists automatically with best supplier offers", "Smart matching subtitle")
	...
	addKey(e, "pharmacy.dashboard.no_smart_orders_msg", "pharmacy", "ارفع ملف Excel أو CSV لاحتياجاتك وسيقوم النظام بمطابقتها واقتراح أرخص وأفضل الموردين المتاحين لمنطقتك.", "Upload Excel or CSV shortage file and the system will match and suggest best supplier offers in your zone.", "Empty smart orders message")
