...
func loadCommonAndAuthKeys(e *engine) {
	...
	addKey(e, "common.select", "common", "اختر من القائمة...", "Select from list...", "Select placeholder")
	addKey(e, "wallet.no_methods_alert_title", "wallet", "لا توجد وسائل دفع أو حسابات بنكية مسجلة", "No payment methods or bank accounts registered", "No payment methods title")
	addKey(e, "wallet.no_methods_alert_desc", "wallet", "يجب إضافة وسيلة دفع (حساب بنكي، انستاباي، أو محفظة إلكترونية) لتتمكن من استلام أرباحك وإتمام طلبات السحب.", "You must add a payment method (bank account, InstaPay, or mobile wallet) to receive your earnings and request withdrawals.", "No payment methods description")
	addKey(e, "wallet.add_method_now", "wallet", "+ إضافة وسيلة دفع الآن", "+ Add Payment Method Now", "Add method button")
