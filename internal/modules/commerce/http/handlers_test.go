...
func (r stubRepo) GetVendorShipmentByOrderID(ctx context.Context, orderID, vendorOrgID int64) (*commerce.OrderShipment, error) {
	r.fail("GetVendorShipmentByOrderID")
	return nil, nil
}
