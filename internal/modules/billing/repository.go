...
type Repository interface {
	...
	ListInvoicesByOrgWithTotal(ctx context.Context, orgID int64, limit, offset int) ([]*Invoice, int, error)
	...
	CreateWithdrawalRequest(ctx context.Context, w *WalletWithdrawal) error
