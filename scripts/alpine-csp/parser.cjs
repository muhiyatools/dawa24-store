// Generated: the expression Tokenizer and Parser from @alpinejs/csp 3.17.3
// (packages/csp/src/parser.js, dist/cdn.js). Kept byte-for-byte so the
// template checker accepts exactly what the browser build accepts.
// Regenerate when internal/ui/static/vendor/alpine-csp-*.min.js changes.
"use strict";
  var Token = class {
