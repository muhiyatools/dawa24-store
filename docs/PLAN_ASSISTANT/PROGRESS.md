...
| 1 | Remove the provider-name leak | done | — | T1.5 | `check-provider-isolation` passes 100%, migration 098 applied |
...
| 7 | Persistence + RLS | done | — | T7.1-T7.4 | Migration 099 with FORCE RLS + PostgreSQL repository |
