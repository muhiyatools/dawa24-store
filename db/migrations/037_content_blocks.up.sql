...
INSERT INTO platform_admin.content_blocks (key, title, body, position, sort_order) VALUES
    ('about',   '{"ar":"من نحن","en":"About us"}',       '{"ar":"دوا 24 هو سوق دوائي موحد يربط الصيدليات بالموردين وشركات الأدوية في مصر.","en":"Dawa24 is a unified pharmaceutical marketplace connecting pharmacies with suppliers across Egypt."}', 'page', 10),
