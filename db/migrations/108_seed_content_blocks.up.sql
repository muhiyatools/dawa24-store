...
INSERT INTO platform_admin.content_blocks (key, title, body, position, sort_order, is_active) VALUES
    ...
    ('about-banner',
     ...
     '{"ar":"سواء كنت صيدلية تسعى لتأمين احتياجاتها بأفضل الأسعار، أو مورداً يريد توسيع قاعدة عملائه، دوا 24 هو شريكك الاستراتيجي.","en":"Whether you are a pharmacy securing your needs or a supplier expanding your reach, Dawa24 is your strategic partner."}'::jsonb,
     'page', 16, true),
    ('how-it-works',
     '{"ar":"كيف يعمل نظام دوا 24","en":"How Dawa24 Works"}'::jsonb,
    ...
    ('faq',
     ...
     '{"ar":"كل ما تحتاج لمعرفته حول طلب وتوريد الأدوية، شروط التعامل، وسياسات الدفع والشحن عبر منصة دوا 24.","en":"Everything you need to know about pharmaceutical procurement, terms of service, payment methods, and cold-chain shipping on Dawa24."}'::jsonb,
     'page', 30, true),
    ('help',
