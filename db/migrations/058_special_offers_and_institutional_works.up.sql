-- Migration 058: Special Offers with Geographic Coverage & Branch Institutional Works
-- Implements Laravel-parity for Special Offers, Location Coverage, and 12 Institutional Works.

BEGIN;

-- 1. Branch Institutional Works Table (العمل المؤسسي للفروع)
CREATE TABLE IF NOT EXISTS org.branch_institutional_works (
    ...
    work_category   TEXT NOT NULL, -- group, sector, startup, sole_proprietorship, audience_category, retail, nonprofit, factory, cooperative, services, pharmacy, joint_stock
...
-- 2. Special Offers Table (عروض المؤسسة الخاصة)
...
-- 3. Special Offer Products (منتجات العرض المخصصة)
...
-- 4. Special Offer Location Coverage (نطاقات التغطية الجغرافية للعرض)
CREATE TABLE IF NOT EXISTS promo.special_offer_locations (
    ...
    radius              INT NOT NULL DEFAULT 500, -- in meters
...
-- 5. Ensure Egypt Country and Egyptian Cities Seed Data Exist
DO $$
DECLARE
    v_country_id BIGINT;
BEGIN
...
-- 6. Ensure Required Organization Role Keys Exist in identity.roles
